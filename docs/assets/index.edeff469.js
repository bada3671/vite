...
var ue = { current: null },
  kr = { transition: null },
  yc = { ReactCurrentDispatcher: ue, ReactCurrentBatchConfig: kr, ReactCurrentOwner: Bo };
L.Children = {
  map: tr,
...
function ws(e) {
  if (e.tag === 13) {
    ...
    if (
      (n === null && ((e = e.alternate), e !== null && (n = e.memoizedState)), n !== null)
    )
      return n.dehydrated;
  }
  return null;
...
function dt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    co || ((co = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, Kc)));
}
function Ft(e) {
  function n(l) {
    return dt(l, e);
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              h !== null &&
              ((d = h), f !== null && ((h = Mt(a, f)), h != null && k.push(At(a, h, d)))),
            F)
          )
            break;
          a = a.return;
...
function oa(e) {
  ...
  function s(f, a, d, h) {
    ...
    return E === Dn
      ...
      : a !== null &&
        (a.elementType === E ||
          (typeof E == 'object' && E !== null && E.$$typeof === Ze && Ci(E) === a.type))
...
function gu(e, n, t, r, l, o) {
  if (
    ...
    do {
      ...
      (o += 1), (G = K = null), (n.updateQueue = null), (xr.current = Zf), (e = t(r, l));
    } while (Pt);
  }
  if (
    ((xr.current = Gr),
...
function aa(e, n) {
  ...
  if (
    ...
    if (((t.flags |= 2048), Kt(9, fa.bind(null, t, r, l, n), void 0, null), Z === null))
      throw Error(y(349));
    (Pn & 30) !== 0 || ca(t, n, l);
  }
  return l;
...
function Kf(e, n, t) {
  var r = an(e);
  if (
    ((t = { lane: r, action: t, hasEagerState: !1, eagerState: null, next: null }), _a(e))
  )
    xa(n, t);
...
var Gr = {
  ...
  Xf = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        (t = t != null ? t.concat([e]) : null), Nr(4194308, 4, ga.bind(null, n, e), t)
      );
    },
  ...
  switch ((iu(n), n.tag)) {
          ...
          for (var u in o)
            if (o.hasOwnProperty(u)) {
              ...
              u === 'children'
                ? typeof i == 'string'
                  ? r.textContent !== i &&
                    (o.suppressHydrationWarning !== !0 && dr(r.textContent, i, e),
                    (l = ['children', i]))
                  : typeof i == 'number' &&
                    r.textContent !== '' + i &&
                    (o.suppressHydrationWarning !== !0 && dr(r.textContent, i, e),
      ...
      return (n.flags & 128) !== 0
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((n.child.flags |= 8192),
            (n.mode & 1) !== 0 &&
              (e === null || (U.current & 1) !== 0 ? Y === 0 && (Y = 3) : zu())),
    ...
    case 23:
      return (
        ...
        r && (n.mode & 1) !== 0
          ? (pe & 1073741824) !== 0 && (ne(n), n.subtreeFlags & 6 && (n.flags |= 8192))
          : ne(n),
        null
      );
    case 24:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[wo], delete n[Af], delete n[Vf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Aa(e, n, t) {
  ...
  switch (t.tag) {
    ...
    case 1:
      if (
        !te &&
        (Hn(t, n), (r = t.stateNode), typeof r.componentWillUnmount == 'function')
      )
        try {
...
function Ba(e, n, t) {
  for (var r = (e.mode & 1) !== 0; S !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      (l.subtreeFlags & 8772) !== 0 && o !== null ? ((o.return = l), (S = o)) : ji(e);
  }
}
function ji(e) {
  for (; S !== null; ) {
...
function be(e, n) {
  for (
    n &= ~_u, n &= ~cl, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes;
    0 < n;
...
Ga = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if ((e.lanes & t) === 0 && (n.flags & 128) === 0) return (ae = !1), ed(e, n, t);
      ae = (e.flags & 131072) !== 0;
    }
  ...
  switch (((n.lanes = 0), n.tag)) {
    ...
    case 14:
      return (
        (r = n.type), (l = Pe(r, n.pendingProps)), (l = Pe(r.type, l)), Ti(e, n, r, l, t)
      );
    case 15:
...
function ec(e, n, t) {
  ...
  return { $$typeof: _d, type: e, key: o, ref: u, props: l, _owner: Pd.current };
}
hl.Fragment = xd;
hl.jsx = ec;
hl.jsxs = ec;
      ...
      yt('div', {
        children: [
          ...
          $e('a', {
            ...
            target: '_blank',
            children: $e('img', { src: Ed, className: 'logo react', alt: 'React logo' }),
          }),
        ],
      }),
